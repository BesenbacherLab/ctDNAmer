...
A complete list of configuration parameters with human readable descriptions is available in the [config schema](https://github.com/BesenbacherLab/ctDNAmer/tree/main/workflow/schemas/config.schema.yaml).
