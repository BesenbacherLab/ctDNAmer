...
if not glu_path: 
    ...
    rule loop_union_germline:
        input:
            get_glu_input,
        output:
            combined_file="results/germline_union/germline_union_{glu_samples_comb}.kmc_pre",
            combined_file_suf="results/germline_union/germline_union_{glu_samples_comb}.kmc_suf",
        resources:
            mem_mb=50000,
        ...
        shell:
            ...
            kmc_tools -t{threads} -v simple {params.i_suf_rm[1]} -ci1 -cx1000000000 {params.i_suf_rm[0]} -ci1 -cx1000000000 union ${{scratch_kmers}} -ci1 -cx1000000000 -cs1000000000 -ocmin 2> {log}
