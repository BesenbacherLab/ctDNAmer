...
rule count_donor_kmers:
    ...
    output: 
        kmers_pre = temp("results/donors/{donor}/kmers.kmc_pre"), 
        kmers_suf = temp("results/donors/{donor}/kmers.kmc_suf"),
    resources: 
        mem_mb = 50000, 
...
rule make_count_summary_donors:
    input: 
        ...
        kmers_suf = "results/donors/{donor}/kmers.kmc_suf",
    output: 
...
rule calculate_donor_mean_count:
    ...
    conda:
        "../envs/R4_1.yaml"
    script:
        "../scripts/calculate_donor_mean_count.R" 
...
rule intersect_UT_and_donor_kmers:
    input:
        ...
        donor_suf = "results/donors/{donor}/kmers.kmc_suf",
    output:
...
rule dump_intersection_donor_counts:
    input:
        kmc_pre = "results/patients/{pt}/empirical_noise/{donor}/donor_counts.kmc_pre",
    output:
...
rule model_empirical_noise:
    ...
    output:
        param_estimates = "results/patients/{pt}/empirical_noise/estimates.csv",
        traceplot = "results/patients/{pt}/empirical_noise/traceplot.png",
        autocorr = "results/patients/{pt}/empirical_noise/autocorrelation.png",
        summary_txt = "results/patients/{pt}/empirical_noise/modeling_summary.txt",
